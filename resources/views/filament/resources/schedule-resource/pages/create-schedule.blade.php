{{-- resources/views/filament/resources/schedule-resource/pages/create-schedule.blade.php --}}

<x-filament-panels::page>
    <form wire:submit="create" class="space-y-6">
        {{ $this->form }}

        {{-- Таблица расписания 7x7 (если класс выбран) --}}
        @if($this->form->getState('school_class_id'))
